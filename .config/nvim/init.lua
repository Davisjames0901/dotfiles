...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sc', ':Telescope conflicts<CR>', { desc = '[S]earch merge [C]onflicts' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          vim.keymap.set('n', '<leader>ch', vim.lsp.buf.signature_help, { desc = '[C]ode [H]elp' })
          ...
          map('<leader>cd', vim.diagnostic.open_float, 'Open Diagnostic', { 'n', 'x' })
      ...
      require('mason-lspconfig').setup {
        ...
        handlers = {
          function(server_name)
            ...
            local custom_setup = customs[server_name]
            if customs_setup ~= nil then
              custom_setup()
            end
          end,
        },
